        ...
        <div className="flex flex-col h-full ">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#136FB6] focus:ring-2 focus:ring-[#136FB6] focus:ring-opacity-50"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-[#136FB6] hover:bg-[#105E9A] text-white font-semibold py-3 rounded-lg transition-colors mt-6 mb-6"
          >
            Submit
          </button>
        </form>
