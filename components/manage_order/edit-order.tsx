        ...
        <form onSubmit={handleSubmit} className="space-y-5 px-6 py-6 flex-1 overflow-y-auto">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-[#136FB6]  cursor-pointer bg-white text-[#136FB6] font-semibold transition-colors"
            >
