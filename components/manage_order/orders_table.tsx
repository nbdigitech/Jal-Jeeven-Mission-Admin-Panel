...
const statusStyles: Record<Order["status"], string> = {
  Pending: "bg-[#136FB6]/10 text-[#0D4B7A]",
        ...
        <TableBody>
          {orders.map((order) => (
            ...
            >
              ...
              {/* Message */}
              <TableCell className="px-4 py-4">
                <div className="flex items-center gap-2 text-[#136FB6] cursor-pointer hover:opacity-80">
              ...
              <TableCell className="px-4 py-4">
                <EditOrders
                  ...
                  trigger={
                    <Button
                      variant="ghost"
                      className="flex items-center gap-2 text-[#136FB6] px-3 py-2 rounded-lg font-semibold hover:bg-[#136FB61A]"
                      style={{ backgroundColor: '#136FB61A' }}
                    >
