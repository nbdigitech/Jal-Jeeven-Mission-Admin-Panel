...
const statusStyles: Record<OrderHistory["status"], string> = {
  ...
  Processing: "bg-[#136FB6]/10 text-[#0A3A5E]",
    ...
    <>
            ...
            <TableBody>
              {orders.map((order) => (
                <TableRow key={order.id} className="hover:bg-gray-50 border-b">
                  ...
                  {/* Message */}
                  <TableCell className="px-4 py-4">
                    <div className="flex items-center gap-2 text-[#136FB6]/80">
                  ...
                  <TableCell className="px-4 py-4">
                    <button
                      ...
                      className="flex items-center gap-1 text-[#136FB6] hover:text-[#105E9A] transition"
                    >
      ...
      <Sheet open={openDrawer} onOpenChange={setOpenDrawer}>
        <SheetContent className="w-full sm:max-w-md p-0 flex flex-col">
          {/* Orange Header */}
          <div className="bg-[#136FB6] text-white px-6 py-4 flex justify-between items-center mb-6">
              ...
              <>
                ...
                <div>
                  ...
                  <Select value={newStatus} onValueChange={(value) => setNewStatus(value as OrderHistory["status"])}>
                    <SelectTrigger className="w-full px-4 py-2 border-2 border-[#136FB6] rounded-lg focus:outline-none focus:border-[#136FB6] appearance-none cursor-pointer bg-white text-[#136FB6] font-semibold">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <button
                  ...
                  className="w-full bg-[#136FB6] hover:bg-[#105E9A] text-white font-bold py-3 px-4 rounded-lg transition-colors mt-8"
                >
                  Save Changes
                </button>
              </>
