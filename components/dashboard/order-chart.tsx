      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-3 items-center">
          ...
          <Select defaultValue="week">
            <SelectTrigger className="w-[120px] h-8 text-sm font-medium bg-[#136FB61A] border-none rounded-md">
          ...
          >
            ...
            <defs>
              <linearGradient id="fillGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#136FB6" stopOpacity={0.35} />
                <stop offset="100%" stopColor="#136FB6" stopOpacity={0.05} />
              </linearGradient>
