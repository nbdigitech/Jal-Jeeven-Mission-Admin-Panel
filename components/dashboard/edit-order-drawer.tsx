...
export default function EditOrderDrawer({
  ...
  qty = "550 Ton",
  rate = "45,000",
  trigger = <button className="text-[#136FB6] hover:text-[#136FB6] font-bold">Edit</button>,
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent className="w-[426px] p-0 flex flex-col [&>button]:hidden">
        {/* Remove Close Button */}
        {/* Orange Header */}
        <div className="flex justify-items-center justify-between bg-[#136FB6] text-white px-6 py-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 px-6 py-6 flex-1 overflow-y-auto">
          ...
          <div>
            ...
            <input
              ...
              className="w-full  px-4 py-2.5 border-2 border-gray-300 rounded-lg bg-white text-gray-700 font-medium focus:outline-none focus:border-[#136FB6] transition-colors"
            />
          </div>
          ...
          <div className="text-right -mt-2">
            <p className="text-sm font-semibold text-[#136FB6]">Pending 150 Ton</p>
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-[#136FB6] appearance-none cursor-pointer bg-white text-[#136FB6] font-semibold transition-colors"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-[#136FB6] resize-none text-sm text-gray-600 transition-colors"
          ...
          <div className="text-center py-4">
            <p className="text-sm font-semibold text-[#009846]">Rate : ₹ {rate}</p>
          </div>

          {/* Submit Button */}
          <button
            type="submit"
            className="w-full bg-[#136FB6] hover:bg-[#105E9A] text-white font-bold py-3 px-4 rounded-lg transition-colors"
          >
            Update Order
          </button>
        </form>
