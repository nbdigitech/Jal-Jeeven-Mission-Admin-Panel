...
export default function UpdateRemarkDrawer({
  surveyId,
  currentRemark = "",
  trigger = <button className="text-[#136FB6] hover:text-[#136FB6] font-bold">Remark</button>,
        ...
        <div className="p-4 space-y-4 flex-1 overflow-y-auto text-[#929292]">
          ...
          <div>
            ...
            <input
              ...
              className="w-full mt-1 px-3 py-2 border rounded-lg text-sm focus:border-[#136FB6]  "
            />
          </div>
          ...
          <div>
            ...
            <div className="relative mt-1">
              <input
                ...
                className="w-full px-3 py-2 border rounded-lg text-sm  pr-10 focus:border-[#136FB6] focus:border-2"
              />
              <MapPin
                size={16}
          ...
          <div>
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="w-full mt-1 justify-start text-left font-normal focus:border-[#136FB6] focus:ring-[#136FB6]"
                >
          ...
          {/* Button */}
          <button className="w-full bg-[#136FB6] hover:bg-[#105E9A] text-white py-3 rounded-lg font-semibold text-sm">
            Submit Remark
          </button>
        </div>
      </SheetContent>
