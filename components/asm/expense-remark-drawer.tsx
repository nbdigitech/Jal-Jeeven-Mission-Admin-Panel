...
export default function ExpenseRemarkDrawer({
  ...
  onUpdateRemarks,
  trigger = (
    <button className="bg-[#136FB6] hover:bg-[#105E9A] text-white font-semibold flex items-center px-4 py-2 rounded-lg gap-2">
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent className="w-[420px] p-0 flex flex-col [&>button]:hidden">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
          {/* Route */}
          <div>
            <p className="text-sm font-semibold text-[#136FB6]">
              {routeTitle}
            </p>
          ...
          <div>
            ...
            <input
              ...
              className="w-full mt-1 px-4 py-3 border rounded-lg text-sm focus:border-[#136FB6] outline-none"
          ...
          <div>
            ...
            <div className="relative mt-1">
              <select
                ...
                className="w-full px-4 py-3 border rounded-lg text-sm appearance-none focus:border-[#136FB6] outline-none"
              >
                <option>Approved</option>
                <option>Pending</option>
                <option>Rejected</option>
              </select>
              <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#136FB6]" />
            </div>
          </div>
        </div>
        ...
        <div className="px-6 pb-6">
          <button
            ...
            className="w-full bg-[#136FB6] hover:bg-[#105E9A] text-white py-3 rounded-lg font-semibold"
          >
            Submit Remark
          </button>
        </div>
