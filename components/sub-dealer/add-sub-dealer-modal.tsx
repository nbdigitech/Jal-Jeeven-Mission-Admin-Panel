            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                 ...
                 <div>
                  <label className={`text-xs font-semibold block mb-2 transition ${
                    focusedField === "influencerCategory" ? "text-[#136FB6]" : "text-gray-700"
                  ...
                  <Select onOpenChange={(open) => {
                    ...
                    <SelectTrigger className={`w-full border-2 transition ${
                      focusedField === "influencerCategory" ? "border-[#136FB6]" : "border-gray-300"
                    }`}>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className={`text-xs font-semibold block mb-2 transition ${
                    focusedField === "photo" ? "text-[#136FB6]" : "text-gray-700"
                  }`}>Upload Photo</label>
                  <Input 
                    type="file" 
                    placeholder="Choose file" 
                    className={`w-full border-2 transition ${
                      focusedField === "photo" ? "border-[#136FB6]" : "border-gray-300"
                    }`}
