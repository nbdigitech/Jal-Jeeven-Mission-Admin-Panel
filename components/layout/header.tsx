       ...
       <div className="flex justify-between">
        ...
        <div className="hidden sm:flex relative bg-[#F3F5FA] w-72 mr-6">
          <input
            ...
            className="w-full px-4 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#136FB6]"
          />
        ...
        <div className="flex items-center gap-5">
          <Link href="/notifications" className="bg-[#F3F5FA] p-2 rounded-lg hover:bg-[#136FB6]/10 transition">
            <Bell className="w-5 h-5 text-gray-300 hover:text-[#136FB6]" />
          </Link>
          <Link href="/emails" className="bg-[#F3F5FA] p-2 rounded-lg hover:bg-[#136FB6]/10 transition">
            <Mail className="w-5 h-5 text-gray-300 hover:text-[#136FB6]" />
          </Link>
          <div className="w-9 h-9 rounded-full bg-[#136FB6] flex items-center justify-center text-white">
